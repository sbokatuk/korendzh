        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateTag = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceLabel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VkUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_EntityType_EntityId_At",
                table: "AuditLog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pages_IsPublished_ShowInMenu_MenuOrder",
                table: "Pages",
                columns: new[] { "IsPublished", "ShowInMenu", "MenuOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_IsPublished_DisplayOrder",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_WorkerId_WorkDate",
                table: "TimeEntries",
